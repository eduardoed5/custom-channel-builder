...
namespace CreatorChannelsXrmToolbox
{
    ...
    [Export(typeof(IXrmToolBoxPlugin)),
        ExportMetadata("Name", "Custom Channels Solution Builder"),
        ExportMetadata("Description", "This component allows you to create a Dynamics 365 solution to establish a custom channel in Customer Insights - Journeys."),
